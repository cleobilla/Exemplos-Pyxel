...
class Personagem:
    ...
    def draw(self):
        ...
        pyxel.blt(self.x1,self.y1, # Onde desenhar na janela
                  0, # qual matriz de imagem
                  0,0, # onde começa a imagem na matriz
                  self.altura,self.largura, # largura e altura da imagem a ser desenhada
                  13) # cor do fundo que é transparente
...
class Jogo:
    def __init__(self):
        ...
        # Atributos aqui
        self.heroi = Personagem(10,10,16,16,7)
        self.inimigo = Personagem(80,80,16,16,10)
